...
The \emph{dac.c} file has the sole purpose of enabling the digital/analouge converter.

\emph{timer.c} is a file that enables the timer interupts.
\emph{gpio.c} is a file that initializes the GPIO registers.
\emph{interrupt\_handler.c} is where we handle the GPIO interrupts and the timer interuptes.
Finally the \emph{ex2.c} is where the main function is and where the initialisers where ran.
