...
The Makefile had targets for building the file for uploading, the ELF file used with GDB and for actually uploading the code to the micro-controller.

An \emph{efm32gg.h} file that contained all the registries that will be needed in this exercises were given since the coding would be done in C.
The skeleton code is spread across 4 \emph{.c} files.
The files were \emph{dac.c} \emph{ex2.c} \emph{gpio.c} \emph{interrupt\_handlers.c} and \emph{timer.c}.
