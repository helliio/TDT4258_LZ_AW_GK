...
The convert the signal to match the values used by DAC in the c program on the microcontroller it was necessary to increase the numbers $\in [-1, 1]$ to $\in [0, \text{fff}_{16}]$. This was done with equation (\ref{eq:matlab}).
